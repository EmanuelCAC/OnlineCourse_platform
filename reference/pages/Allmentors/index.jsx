        ...
        <div className="flex flex-row justify-center w-full">
          ...
          >
            <TabList className="flex flex-row md:flex-col justify-center w-full gap-20 p-3.5 md:gap-10">
              <Tab className="ml-[193px] md:ml-5 text-gray-900 text-base font-medium">All Mentors</Tab>
              ...
              <Tab className="mr-[193px] md:mr-5 text-gray-900 text-base font-medium">For Technology</Tab>
            </TabList>
            ...
            <div className="flex flex-row justify-center items-center w-[23%] md:w-full gap-[19px]">
              <Text as="p" className="ml-[61px] md:ml-5 !text-gray-900 !font-medium">
                Page
              </Text>
              <Button color="white_A700" size="sm" className="!text-gray-700_01 font-medium min-w-[39px] rounded-lg">
                1
              </Button>
              <Text as="p" className="mr-[61px] md:mr-5 !text-gray-900 !font-medium">
                of 03
              </Text>
            </div>
          </Tabs>
